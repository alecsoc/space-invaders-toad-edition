...
class Player(pygame.sprite.Sprite):
    ...
    def get_player_input(self, e):
        if e.type == pygame.KEYDOWN:
            if e.key == pygame.K_LEFT: self.moving_left = True
            if e.key == pygame.K_RIGHT: self.moving_right = True
        elif e.type == pygame.KEYUP:
            if e.key == pygame.K_LEFT: self.moving_left = False
            if e.key == pygame.K_RIGHT: self.moving_right = False
